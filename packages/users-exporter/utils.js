...
export const loadUsers = async ({ groupId, appId, lastUser, cookie, traceId, password = "temp-password" }) => {
    const users = []
    ...
    const CONFIG = {
        "headers": {
            ...
            "cookie": cookie,
            "Referer": "https://services.cloud.mongodb.com/groups/600daac31bee660769895af1/apps/600dac958546a86b86a90927/auth/users",
    ...
    try {
        ...
        if (data.length > 0) {
            ...
            console.log("🚀 ~ loadUsers ~ innerUsers:", innerUsers)
