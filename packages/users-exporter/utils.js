...
export const loadUsers = async ({
  ...
  const CONFIG = {
    headers: {
      ...
      baggage: `sentry-environment=prod,sentry-release=4.115.0,sentry-public_key=xxxxxx,sentry-trace_id=${traceId},sentry-sample_rate=0,sentry-sampled=false`,
      ...
      cookie: cookie,
      Referer: 'https://services.cloud.mongodb.com/groups/xxxx/apps/xxxxx/auth/users',
