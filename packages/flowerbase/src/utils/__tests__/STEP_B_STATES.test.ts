...
import {
  evaluateDocumentFiltersReadFn,
  evaluateDocumentFiltersWriteFn
} from '../roles/machines/read/B/validators'
import * as Utils from '../roles/machines/utils'
const {
  checkDocumentsFilters,
  evaluateDocumentsFiltersRead,
...
describe('STEP_B_STATES', () => {
  ...
  it('evaluateDocumentsFiltersRead should go to next stage if document_filters read is valid', async () => {
    ...
    await evaluateDocumentsFiltersRead({
      endValidation,
      context: mockContext,
      goToNextValidationStage,
      next,
  ...
  it('evaluateDocumentFiltersWriteFn should go to next stage if document_filters write is valid', async () => {
    ...
    await evaluateDocumentsFiltersWrite({
      endValidation,
      context: mockContext,
      goToNextValidationStage,
      next,
